...
export default function SVG(props) {
  const { id, width, height, ...others } = props;
  return (
    <div className="planet-Icon">
      <div className="container">
        <svg height={height} width={width} viewBox="0 0 501.381 501.381">
          <g id={id} {...others}>
            <path
              style={{ fill: "none" }}
              d="M71.312,339.206c-0.53-1.071-1.051-2.147-1.562-3.229c-0.153-0.323-0.302-0.647-0.453-0.971
            ...
            <path
              style={{ fill: "none" }}
              d="M455.51,167.246c-2.554-6.269-12.304-9.214-27.527-9.176c5.802,11.084,10.594,22.778,14.257,34.962
                    C453.144,182.428,458.063,173.511,455.51,167.246z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M364.025,104.024c-68.087,0-128.217,34.032-164.337,86.005c7.352-3.214,14.827-6.378,22.429-9.475
            ...
            <path
              style={{ fill: "#708AFF" }}
              d="M90.102,369.885c-0.578-0.777-1.144-1.563-1.711-2.349
                    C88.956,368.323,89.525,369.107,90.102,369.885z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M285.187,53.664c1.202,0.209,2.399,0.434,3.594,0.665C287.586,54.099,286.389,53.873,285.187,53.664
                    z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M289.904,54.544c1.281,0.255,2.556,0.525,3.827,0.805C292.459,55.07,291.185,54.799,289.904,54.544z
                    "
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M299.141,56.613c1.447,0.361,2.888,0.737,4.322,1.129C302.028,57.35,300.588,56.973,299.141,56.613z
                    "
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M442.191,193.081c0.017-0.016,0.032-0.032,0.049-0.049c-3.663-12.185-8.455-23.879-14.257-34.962
            ...
            <path
              style={{ fill: "#708AFF" }}
              d="M69.75,335.978c0.511,1.082,1.032,2.158,1.562,3.229C70.782,338.135,70.261,337.059,69.75,335.978z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M66.033,327.62c0.44,1.056,0.894,2.104,1.352,3.151C66.927,329.724,66.473,328.675,66.033,327.62z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M64.301,323.333c0.415,1.065,0.846,2.122,1.279,3.177C65.147,325.455,64.716,324.398,64.301,323.333
                    z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M62.66,318.981c0.403,1.108,0.823,2.208,1.244,3.307C63.482,321.189,63.062,320.089,62.66,318.981z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M86.967,365.539c-0.077-0.109-0.152-0.219-0.229-0.329C86.815,365.32,86.891,365.43,86.967,365.539z
                    "
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M67.851,331.837c0.472,1.062,0.956,2.117,1.446,3.17C68.807,333.954,68.323,332.899,67.851,331.837z
                    "
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M59.143,308.342l-0.001,0.001c1.017,3.384,2.118,6.732,3.307,10.038
                    C61.259,315.076,60.161,311.726,59.143,308.342z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M294.554,55.528c1.362,0.305,2.719,0.626,4.071,0.959C297.273,56.154,295.917,55.833,294.554,55.528
                    z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M51.413,267.635c-0.059-0.699-0.121-1.398-0.173-2.099
                    C51.292,266.237,51.354,266.936,51.413,267.635z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M265.767,51.254c0.892,0.067,1.78,0.151,2.669,0.229C267.547,51.405,266.66,51.32,265.767,51.254z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M50.813,257.324c-0.018-0.552-0.045-1.102-0.058-1.656
                    C50.768,256.222,50.795,256.772,50.813,257.324z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M260.784,50.943c0.792,0.039,1.579,0.096,2.369,0.145C262.363,51.04,261.576,50.983,260.784,50.943z
                    "
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M255.759,50.755c0.633,0.016,1.261,0.048,1.892,0.07C257.019,50.803,256.391,50.77,255.759,50.755z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M73.397,343.305C73.397,343.305,73.397,343.305,73.397,343.305
                    c-0.568-1.086-1.127-2.179-1.677-3.277C72.27,341.126,72.828,342.219,73.397,343.305z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M280.413,52.892c1.128,0.168,2.251,0.353,3.374,0.54C282.664,53.245,281.541,53.06,280.413,52.892z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M51.89,272.59c-0.079-0.724-0.159-1.447-0.23-2.173C51.731,271.143,51.811,271.866,51.89,272.59z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M275.583,52.231c1.053,0.131,2.1,0.278,3.148,0.426C277.683,52.51,276.636,52.362,275.583,52.231z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M270.7,51.684c0.976,0.097,1.948,0.211,2.92,0.323C272.647,51.896,271.676,51.781,270.7,51.684z"
            />
            <path
              style={{ fill: "#708AFF" }}
              d="M51.053,262.585c-0.038-0.655-0.083-1.309-0.115-1.966C50.97,261.276,51.015,261.93,51.053,262.585z
                    "
            />
            <path
              style={{ fill: "#3D6EDD" }}
              d="M226.527,449.186c-38.469-36.45-62.502-87.984-62.502-145.162c0-23.737,4.145-46.503,11.734-67.627
            ...
            <path
              style={{ fill: "#3D6EDD" }}
              d="M199.688,190.029c36.12-51.973,96.249-86.005,164.337-86.005c8.185,0,16.237,0.549,24.165,1.505
          ...
          <path
            style={{ fill: "#9DC1FF" }}
            d="M499.727,149.232c-7.739-18.997-41.586-25.296-90.284-20.182
